...
var EasyDialogBox = (function()
{
        ...
        if(matched === true)
        {
            ...
            */
            ...
            if( dlg && (matched === true) )
            {
                ...
                // ** Make it draggable, unless flag is set, and bring current dialogbox to top
                if( !(_hasClass(dlg, 'dlg-disable-drag')) )
                {
                    _drag.init(box.id);
                ...
                // ** END: Make it draggable, unless flag is set, and bring current dialogbox to top
    ...
    var _init = function()
    {
        ...
        _attachEventListener(window, 'load', function LoadWindow()
        {
            ...
            opnr.forEach(function(elm, index)
            {
                _attachEventListener(elm, 'click', function DlgOpenerClick(e)
                {
                    // ** Get/set event variable
                    e = e || window.event;
