...
{   'use strict';
    ...
    const _adjustElSizePos = function(id)
    {
        ...
        if(el)
        {
            ...
            if( _s2d(el.offsetHeight + el.customPosY) >= window.innerHeight)
            {
            ...
            if( _s2d(el.offsetWidth + el.customPosX + overlap) >= window.innerWidth) // Seem to work OK
            {
                // ** Try to retain responsiveness by setting default values 
                el.style.left = '0';
    ...
    const _show = function(objId)
    {
        ...
        if( dlg && (_isActive === false) && (matched === true) )
        {
            ...
            if(obj.x)
            {
                box.style.left = _s2d(obj.x) + 'px';
                box.customPosX = _s2d(obj.x);
            }
            // ** Check if position is set, if true then change position, else default value used
            if(obj.y)
            {
                box.style.top = _s2d(obj.y) + 'px';
                box.customPosY = _s2d(obj.y);
            }
            ...
            if(obj.w)
            {
                box.style.maxWidth = _s2d(obj.w) + 'px';
                box.customWidth = _s2d(obj.w);
            }
            // ** Check if size is set, if true then change size, else default value used
            if(obj.h)
            {
                box.style.height = _s2d(obj.h) + 'px';
                box.customHeight = _s2d(obj.h);
            }
            ...
            )
            {
                ...
                if(box.customHeight)
                {
                    message.style.height = _s2d(obj.h - 101) + 'px';
                }
            ...
            else
            {
                ...
                if(box.customHeight)
                {
                    message.style.height = _s2d(obj.h - 130) + 'px';
                }
            }
            ...
            _orgBodyPaddingRight = _s2d(_orgBodyPaddingRight);
    ...
    const _destroy = function(objId)
    {
        ...
        body.setAttribute('style', 'padding-right:' + _s2d(_orgBodyPaddingRight) + 'px;');
