...
var EasyDialogBox = (function()
{
    ...
    var _adjustElSizePos = function(id)
    {
        ...
        if(el)
        {
            ...
            var winHeight = window.innerHeight || document.documentElement.clientHeight || document.querySelector('body').clientHeight;
            ...
            var winWidth = window.innerWidth || document.documentElement.clientWidth || document.querySelector('body').clientWidth;
    ...
    var _scrollBarFix = function()
    {
        ...
        // ** Get width-difference (which is actually the width of the scrollbar)
        var w3 = w2 - w1;
    ...
    var _hide = function(objId, bSkip)
    {
        ...
        // ** Get body element, restore scrolling, reset padding value
        var body = document.querySelector('body');
