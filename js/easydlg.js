...
var EasyDialogBox = (function()
{
    ...
    _log(_name + ' DEBUG console-output is enabled. You can disable it in "easydlg.js" by setting: DEBUG = false');
    ...
    var _create = function(strId, strTypeClass, strTitle, strMessage, fnCallback, x, y, w, h)
    {
        ...
        //var existingObj = _getObjById(strId + '_0');  // REMOVED, NO LONGER NEEDED
        var existingObj = _getObjById(strId);
        if(existingObj)
        {
        ...
        if(matched === true)
        {
            ...
            //strId += '_0'; // REMOVED, NO LONGER NEEDED
    ...
    var _init = function()
    {
        ...
        for(var i = 0; i < opnr.length; i++)
        {
            ...
            (function()
            {
                ...
                // ** Remove original dialogbox written in HTML to avoid having two identical dialog boxes and dialog content
                dlg.remove();
            }());
        } // ** END: for
