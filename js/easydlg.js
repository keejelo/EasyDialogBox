    ...
    var _hide = function(objId, bSkip)
    {
        ...
        if(dlg && box)
        {
            ...
            if(bSkip !== true && !obj.bFade)
            {
                ...
                obj.bHidden = true;   // Set hidden flags
                obj.bVisible = false; // do we really need both variables?
                obj.onHide();
            }
    ...
    var _init = function()
    {
        ...
        _attachEventListener(window, 'load', function WinLoad()
        {
            ...
            for(var i = 0; i < opnr.length; i++)
            {
                ...
                // ** Since using "var" and not "let" we need to preserve variable scope for "obj", so we wrap it in a selfex-function
                (function()
                {
                    ...
                    // ** Create event listener for boxopeners
