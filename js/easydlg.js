...
var EasyDialogBox = (function()
{
    ...
    var _resize =
    {
        ...
        {
            e = e || window.event;
            _resize.minWidth = _s2i(_getStyle(_resize.el, 'minWidth')) || 100;  // if undefined then default: 100
            _resize.minHeight = _s2i(_getStyle(_resize.el, 'minHeight')) || 36; // if undefined then default: 36
