...
var EasyDialogBox = (function()
{
    ...
    // ** Initialize, activate the HTML box openers
    var _init = function()
    {
        // ** Display message to inform that module is started
        if(window.console.log) { window.console.log('EasyDialogBox initialized'); }

        // ** Window load event
        _attachEventListener(window, 'load', function WinLoad()
        {
            // ** Inform user if debug console-output is enabled
            if(DEBUG)
            {
            ...
            if(window.console.log) { window.console.log('EasyDialogBox ready'); }
        }, false);
