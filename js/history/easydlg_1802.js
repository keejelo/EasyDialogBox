...
var EasyDialogBox = (function()
{
            ...
            if(dlg)
            {
                ...
                if( !(_hasClass(dlg, 'dlg-disable-clickout')) && !(_hasClass(dlg, 'dlg-multi')) )
                {
                    _attachEventListener(dlg, 'click', function ClickOutClose(e)  // changed FROM: window  TO: dlg
                    {
                        ...
                        // ** Get event target (crossbrowser legacy)
                        var targ;
    ...
    var _drag =
    {
        ...
        start : function(e)
        {
            ...
            if( (e.button === 0) || (window.attachEvent && !window.addEventListener && e.button === 1) )
            {
                ...
                // ** If "dlg-disable-heading", only start drag if click is NOT on: input, textarea, button, select
    ...
    var _resize =
    {
        ...
        {
            e = e || window.event;
            _resize.el.style.maxWidth = parseInt( (_resize.width + e.clientX - _resize.posX), 10) + 'px'; // we set "maxWidth" instead of "width" in this case
            ...
            obj.customHeight = _s2i(_resize.el.style.height);
            obj.customWidth = _s2i(_resize.el.style.maxWidth);
            _stopDefault(e);
            return false;
        }
    };
