//-----------------------------------------------------------------------------------------------------------------
// ** EasyDialogBox
// ** Version: 1.733b (0020) (BETA test version)
// ** Year: 2020-2021
...
{   'use strict';
    ...
    var _create = function(strId, strTypeClass, strTitle, strMessage, fnCallback, bKeepAlive, x, y, w, h)
    {
        ...
        if(matched === true)
        {
            ...
            obj.show();  // run here to create in DOM ?  if(bExistInDOM == false) { create in DOM, but not show }
