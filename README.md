...
Important change: 
<br /><br />
<b>Removed parameter "bKeepAlive" from function: EasyDialogBox.create(...);</b>
<br/ ><br />
Usage is now: EasyDialogBox.create(id, strBoxTypeClass, strTitle, strMessage, fnCallback, x, y, w, h);
<br/ ><br />
